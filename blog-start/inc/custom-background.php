...
add_action( 'after_setup_theme', 'blog_start_custom_background_setup', 15 );
 ...
 * @return void
 */
function blog_start_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'blog_start_custom_background_callback',
		)
	);
}
 ...
 * @return void
 */
function blog_start_custom_background_callback() {
