 ...
 * @version    1.0.5
 * @author     Emil Kalibradov <emil@siteholic.com>
 * @copyright  Copyright (c) 2016, SiteHolic
 * @link       http://siteholic.com/blog-start
 * @license    http://www.gnu.org/licenses/old-licenses/gpl-2.0.html
 */

// Get the template directory and make sure it has a trailing slash.
$blog_start_dir = trailingslashit( get_template_directory() );

// Load the Hybrid Core framework and theme files.
require_once( $blog_start_dir . 'library/hybrid.php'        );
require_once( $blog_start_dir . 'inc/custom-background.php' );
require_once( $blog_start_dir . 'inc/custom-header.php'     );
require_once( $blog_start_dir . 'inc/theme.php'             );

// Launch the Hybrid Core framework.
new Hybrid();

// Do theme setup on the 'after_setup_theme' hook.
add_action( 'after_setup_theme', 'blog_start_theme_setup', 5 );
 ...
 * @return void
 */
function blog_start_theme_setup() {
